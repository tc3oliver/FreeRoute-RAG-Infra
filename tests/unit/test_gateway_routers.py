...
@pytest.mark.asyncio
async def test_chat_endpoint_empty_messages(monkeypatch):
    from services.gateway.models import ChatReq
    from services.gateway.routers.chat import chat
...
@pytest.mark.asyncio
async def test_chat_endpoint_service_exception(monkeypatch):
    from services.gateway.models import ChatReq
    from services.gateway.routers.chat import chat
...
@pytest.mark.asyncio
async def test_embed_endpoint_success():
...
@pytest.mark.asyncio
async def test_embed_endpoint_service_exception():
    from services.gateway.models import EmbedReq
    from services.gateway.routers.chat import embed
...
@pytest.mark.asyncio
async def test_rerank_endpoint_success(monkeypatch):
...
@pytest.mark.asyncio
async def test_rerank_endpoint_exception(monkeypatch):
    from services.gateway.models import RerankReq
    from services.gateway.routers import chat
...
@pytest.mark.asyncio
async def test_graph_probe_exception():
    from services.gateway.models import GraphProbeReq
    from services.gateway.routers.graph import graph_probe
...
@pytest.mark.asyncio
async def test_graph_extract_success():
    ...
    async def mock_extract(req, client_ip, **kwargs):
...
@pytest.mark.asyncio
async def test_graph_extract_value_error():
...
@pytest.mark.asyncio
async def test_graph_upsert_runtime_error():
    from services.gateway.models import GraphData, GraphUpsertReq
    from services.gateway.routers.graph import graph_upsert
    ...
    # FastAPI 會將 RuntimeError 轉成 502
...
async def test_graph_query_success():
    ...
    async def mock_query(req, **kwargs):
...
@pytest.mark.asyncio
async def test_graph_query_value_error():
    from services.gateway.models import GraphQueryReq
    from services.gateway.routers.graph import graph_query
...
async def test_index_chunks_success():
    ...
    async def mock_index_chunks(req, **kwargs):
...
@pytest.mark.asyncio
async def test_index_chunks_runtime_error():
    from services.gateway.models import ChunkItem, IndexChunksReq
    from services.gateway.routers.vector import index_chunks
...
async def test_search_success():
    ...
    async def mock_search(req, **kwargs):
...
@pytest.mark.asyncio
async def test_search_runtime_error():
    from services.gateway.models import SearchReq
    from services.gateway.routers.vector import search
...
async def test_retrieve_success():
    ...
    async def mock_retrieve(req, **kwargs):
