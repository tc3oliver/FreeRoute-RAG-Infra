...
from ..repositories import get_async_litellm_client, get_litellm_client
from ..utils import ensure_json_hint, retry_once_429, retry_once_429_async


class ChatService:
    """
    Service for chat completions and embeddings via LiteLLM (synchronous).

    DEPRECATED: Use AsyncChatService for better performance.
